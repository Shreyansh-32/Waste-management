              ...
              >
                ...
                <div className="relative mb-6">
                  <motion.div
                    ...
                    className="w-24 h-24 rounded-full bg-linear-to-br from-emerald-500 to-emerald-700 flex items-center justify-center shadow-2xl shadow-emerald-900/50 border-4 border-emerald-900 group-hover:shadow-emerald-500/30 transition-shadow duration-300"
                  >
