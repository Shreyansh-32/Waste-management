                  ...
                  {weekData.map((d, i) => (
                    <div key={d.day} className="flex-1 flex flex-col items-center gap-1">
                      <motion.div
                        ...
                        className={`w-full rounded-t-lg ${i === weekData.length - 1 ? "bg-linear-to-t from-emerald-600 to-emerald-400" : "bg-emerald-200"}`}
                      />
                    </div>
                  ))}
                </div>
                    ...
                    <div key={m.label}>
                      ...
                      <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-full h-2">
                        <motion.div
                          ...
                          className="h-2 bg-linear-to-r from-emerald-400 to-emerald-600 rounded-full"
                        />
                      </div>
                    </div>
                  ))}
