        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6 lg:gap-8">
            ...
            {isSignedIn && (
              ...
              >
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white text-sm font-bold shrink-0">
                  {initials}
                </div>
                <div>
            ...
            <motion.p
              ...
              className="text-lg text-slate-500 leading-relaxed max-w-lg font-light"
            >
            ...
            >
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold text-base px-8 py-4 rounded-xl shadow-lg shadow-emerald-200 hover:shadow-emerald-300 transition-shadow"
                >
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-white text-emerald-700 font-semibold text-base px-8 py-4 rounded-xl border-2 border-emerald-200 hover:border-emerald-400 hover:bg-emerald-50 transition-all"
                >
            ...
            >
              ...
              <p className="text-sm text-slate-500">
                <span className="font-semibold text-slate-700">12+ campuses</span> already monitoring
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl shadow-emerald-100 border border-emerald-100 overflow-hidden">
                ...
                <div className="p-4 flex flex-col gap-2.5">
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Active Reports</p>
                    <span className="text-xs text-emerald-600 font-medium">3 open</span>
                  </div>
                  {statusItems.map((item, i) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between bg-slate-50 rounded-xl px-3.5 py-3 border border-slate-100"
                    >
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 bg-white shadow-xl shadow-emerald-100 border border-emerald-100 rounded-2xl px-4 py-2.5 flex items-center gap-2"
              >
                <span className="text-lg">🌿</span>
                <div>
                  <p className="text-xs font-bold text-slate-700">Eco Certified</p>
                  <p className="text-[10px] text-slate-400">Smart Campus 2024</p>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -bottom-5 -left-5 bg-white shadow-xl shadow-emerald-100 border border-emerald-100 rounded-2xl px-4 py-2.5 flex items-center gap-2.5"
              >
                <div className="w-8 h-8 bg-emerald-100 rounded-xl flex items-center justify-center">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                </div>
                <div>
                  <p className="text-xs font-bold text-slate-700">Issue Resolved!</p>
                  <p className="text-[10px] text-slate-400">Block C · 2 min ago</p>
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
