    ...
    <>
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-slate-200 dark:border-slate-800 shrink-0">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 dark:text-slate-500 leading-none">Staff Portal</p>
            </div>
          </Link>
        ...
        <nav className="flex-1 overflow-y-auto p-3 space-y-1">
          <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600 px-3 py-2">Staff Menu</p>
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800">
          <div className="bg-sky-50 dark:bg-sky-900/20 rounded-xl p-3">
            <p className="text-xs font-semibold text-sky-700 dark:text-sky-400">Staff Portal</p>
            <p className="text-[11px] text-sky-600/70 dark:text-sky-500/70 mt-0.5">Task management access</p>
          </div>
        </div>
      </aside>
    </>
