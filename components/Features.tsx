          ...
          {features.map((feature) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div
                  className={`w-12 h-12 rounded-2xl bg-linear-to-br ${feature.gradient} flex items-center justify-center mb-5 shadow-md group-hover:scale-110 transition-transform duration-300`}
                >
                ...
                {/* Bottom accent */}
                <div
                  className={`mt-5 h-0.5 w-0 group-hover:w-full bg-linear-to-r ${feature.gradient} rounded-full transition-all duration-500`}
                />
              </motion.div>
            );
          })}
